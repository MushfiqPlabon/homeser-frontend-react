        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-300 mb-4 max-w-md">
              Your trusted partner for all household services. We connect you with skilled professionals 
              to make your home maintenance easy and hassle-free.
            </p>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-300">123 Service St, Dhaka, Bangladesh</span>
              </div>
              <div className="flex items-center space-x-3">
