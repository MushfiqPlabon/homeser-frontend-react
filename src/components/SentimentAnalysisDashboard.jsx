    ...
    <div className="p-6">
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="flex items-center space-x-4">
          ...
          <div>
            <label className="mr-2 text-gray-600">Service:</label>
            <select
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        ...
        <div className="bg-white p-6 rounded-xl shadow-md">
          <h3 className="text-lg font-medium text-gray-900 mb-2">Positive Reviews</h3>
        ...
        <div className="bg-white p-6 rounded-xl shadow-md">
          <h3 className="text-lg font-medium text-gray-900 mb-2">Rating Change</h3>
          <p className={`text-3xl font-bold ${sentimentStats?.data?.rating_change >= 0 ? 'text-green-600' : 'text-red-600'}`}>
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full divide-y divide-gray-200">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {sentimentStats?.data?.top_rated_services?.slice(0, 5).map((service) => (
                  <tr key={service.id}>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      <div className="flex items-center">
                        ...
                        <span className={service.rating_trend >= 0 ? "text-green-600" : "text-red-600"}>
        ...
        <div className="bg-white p-6 rounded-xl shadow-md">
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full divide-y divide-gray-200">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {sentimentStats?.data?.category_sentiment?.slice(0, 5).map((category) => (
                  <tr key={category.id}>
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                      {category.name}
                    </td>
